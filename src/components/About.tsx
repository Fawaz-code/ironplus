...
export default function About() {
  return (
    <section id="about" className="py-16 sm:py-24 bg-brand-black relative overflow-hidden">
      {/* Decorative */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="section-title text-3xl sm:text-4xl md:text-5xl text-white leading-tight mb-6 animate-on-scroll-left stagger-1">
              More Than a Gym —<br />
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 animate-on-scroll-left stagger-4">
              <div className="sm:border-l-2 border-brand-green sm:pl-4">
                <div className="font-montserrat font-900 text-2xl sm:text-3xl text-white">12+</div>
                <div className="font-poppins text-[10px] sm:text-xs text-white/50 uppercase tracking-wider">Years Strong</div>
              </div>
              <div className="sm:border-l-2 border-brand-green sm:pl-4">
                <div className="font-montserrat font-900 text-2xl sm:text-3xl text-white">18K</div>
                <div className="font-poppins text-[10px] sm:text-xs text-white/50 uppercase tracking-wider">Sq Ft Facility</div>
              </div>
              <div className="sm:border-l-2 border-brand-green sm:pl-4">
                <div className="font-montserrat font-900 text-2xl sm:text-3xl text-white">5K+</div>
                <div className="font-poppins text-[10px] sm:text-xs text-white/50 uppercase tracking-wider">Active Members</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-on-scroll-right">
            ...
            {/* Floating card */}
            <div className="absolute -bottom-4 sm:-bottom-6 -left-2 sm:-left-6 bg-brand-dark-card border border-brand-dark-border p-4 sm:p-5 rounded-sm shadow-card max-w-[240px] sm:max-w-xs">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-brand-green/20 flex items-center justify-center">
                  <Award size={16} className="text-brand-green sm:w-5 sm:h-5" />
                </div>
                <div>
                  <div className="font-montserrat font-700 text-xs sm:text-sm text-white">NSCA Certified</div>
                  <div className="font-poppins text-[10px] sm:text-xs text-white/50">All coaching staff</div>
                </div>
              </div>
              <div className="h-0.5 bg-brand-dark-border my-2 sm:my-3" />
              <div className="font-poppins text-[10px] sm:text-xs text-white/60 leading-relaxed">
        ...
        {/* Features grid */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-16 sm:mt-24">
          {features.map((f, i) => (
            <div
              key={f.title}
